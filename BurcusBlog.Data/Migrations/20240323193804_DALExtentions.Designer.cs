...
namespace BurcusBlog.Data.Migrations
{
    ...
    [Migration("20240323193804_DALExtentions")]
    partial class DALExtentions
    {
            ...
            modelBuilder.Entity("BurcusBlog.Entity.Entities.Article", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("9b3e3e5a-da3b-4e42-ac54-70a3a9dde5a2"),
                            ...
                            CreatedDate = new DateTime(2024, 3, 23, 22, 38, 3, 525, DateTimeKind.Local).AddTicks(1747),
                        ...
                        new
                        {
                            Id = new Guid("f8e917f7-3abe-48dd-bd2a-2b1bcf4c55c2"),
                            CategoryId = new Guid("0f3b77ec-8445-4634-b9be-5c2f1180af0c"),
                            Content = " Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.",
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 3, 23, 22, 38, 3, 525, DateTimeKind.Local).AddTicks(1771),
            ...
            modelBuilder.Entity("BurcusBlog.Entity.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 3, 23, 22, 38, 3, 525, DateTimeKind.Local).AddTicks(2452),
                            IsDeleted = false,
                            Name = "Asp.net Core"
                        },
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 3, 23, 22, 38, 3, 525, DateTimeKind.Local).AddTicks(2462),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("BurcusBlog.Entity.Entities.Image", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 3, 23, 22, 38, 3, 525, DateTimeKind.Local).AddTicks(2752),
                        ...
                        new
                        {
                            ...
                            CreatedBy = "Admin Test",
                            CreatedDate = new DateTime(2024, 3, 23, 22, 38, 3, 525, DateTimeKind.Local).AddTicks(2760),
